...
class Params(ParamsBase):
    ...
    crops_per_image = 4  # number of random crops per image, used for faster training
    crop_size = (256, 256)  # crop size of the input image

    # Training Regime

    class_weights = [1., 1., 1.]  # Weight for loss on Foreground, Background and Edge
    ...
    load_checkpoint_path = 'Training/model_1000.ckpt'  # Path to checkpoint
    # Saving Checkpoints
